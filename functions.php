...
function adf_intl_scripts() {
	...
	wp_enqueue_script( 'sow', get_template_directory_uri() . '/_js/lib/sow.js', array('jquery', 'slick'), time(), true );
	wp_enqueue_style( 'sow-style', get_template_directory_uri() . '/css/sow.css', array(), time() );
